    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                ...
                                <div>
                                    <span class="heading">{{$currency_symbol}}{{$income}}</span>
                                    <span class="description">{{__('Income')}}</span>
                                </div>
                                <div>
                                    <span class="heading">{{$users_count}}</span>
        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{url('/owner/profile/update')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <img id="output" src="{{asset('storage/images/users/'.$user->image)}}" class="uploadprofileimg mt-3"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @endphp
                                <input type="number" min="1" class="form-control" value="{{old('code', $code)}}" name="code" id="code" placeholder="{{__('Country Code')}}">
                                @error('code')                                    
                                    <div class="invalid-div">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="{{old('phone', $user->phone)}}" name="phone" id="phone" placeholder="{{__('Phone number')}}">
                                @error('phone')                                    
                                    <div class="invalid-div">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="name">{{__('Language')}}</label>
                                <select name="language" id="language" class="form-control mb-4">
                                    @foreach ($language as $lang)
                                        <option value="{{$lang->name}}" {{Auth::user()->language === $lang->name ? 'selected':''}}> {{$lang->name}} </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <hr class="my-4" />
                    <form class="form-horizontal" action="{{url('/owner/profile/changepassword')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        <h6 class="heading-small text-muted mb-4">{{ __('Password') }}</h6>
                        <div class="pl-lg-4">
                            <div class="form-group">
                                <label class="form-control-label" for="old_password">{{__('Current Password')}}</label>
                                <input type="password" class="form-control" name="old_password" id="old_password" placeholder="{{__('Current Password')}}" autocomplete="current-password">
                                @error('old_password')                                    
                                    <div class="invalid-div">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="new_password" id="new_password" placeholder="{{__('New Password')}}" autocomplete="new-password">
                                @error('new_password')                                    
                                    <div class="invalid-div">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="{{__('Confirm New Password')}}" autocomplete="new-password">
