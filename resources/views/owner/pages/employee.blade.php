        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <button class="btn btn-primary addbtn float-right p-2"><a class="color-white" href="{{url('owner/employee/create')}}"><i class="fas fa-plus mr-1"></i>{{__('Add New')}}</a></button> 
                </div>
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            @if ($give_service == "Both")
                                <th scope="col" class="sort">{{__('Give Services At')}}</th>
                            @endif
                                ...
                                <tr>
                                    ...
                                    <td class="table-actions">
                                        @php
                                            $base_url = url('/');
                                        @endphp
                                        <a href="{{url('owner/employee/'.$emp->emp_id)}}" class="table-action text-warning" data-toggle="tooltip" data-original-title="{{__('View employee')}}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{url('owner/employee/edit/'.$emp->emp_id)}}" class="table-action text-info" data-toggle="tooltip" data-original-title="{{__('Edit employee')}}">
                                            <i class="fas fa-user-edit"></i>
                                        </a>
                                        <button class="btn-white btn shadow-none p-0 m-0 table-action text-danger bg-white" onclick="deleteData('owner/employee',{{$emp->emp_id}},'{{$base_url}}')" data-toggle="tooltip" data-original-title="{{__('Delete employee')}}">
