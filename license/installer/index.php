...
<head>
    <meta charset="utf-8" />
    <title>The Barber - Installer</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <style>
    :root {
        --primary_color: #e06287;
        --primary_color_hover: #e06287cc;
    }
    </style>
    <link href="../../public/includes/css/loginStyle.css" rel="stylesheet">
...
<body>
    ...
    <div id="main_loader">
        ...
        <div class="Preloader">
            <img src="../../public/storage/images/app/loader.gif" alt="Preloader">
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row h100">
                <div class="col-md-6 p-0 m-none"
                    style="background: url('../../public/storage/images/app/bg_img_static.jpg') center center;background-size: cover;background-repeat: no-repeat;">
                    <span class="mask bg-gradient-dark opacity-6"></span>
                </div>
                <div class="col-md-6 data-box-col">
                    <div class="login">
                            ...
                            <div class="">
                                <div class="">
                                    <div class="column is-8 is-offset-2">
                                        <center>
                                            <h1 class="title login_head">The Barber Installer</h1><br>
                                        </center>
                                        <div class="box">
                                            <?php
                                    switch ($step) {
                                        ...
                                        ?>
                                            <div style='text-align: right;'>
                                                <?php if($errors==true){ ?>
                                                <a href="#" class="btn btn-lg btn-primary btn-block btn-salon"
                                                    disabled>Next</a>
                                                <?php }else{ ?>
                                                <a href="index.php?step=0"
                                                    class="btn btn-lg  btn-primary btn-block btn-salon">Next</a>
                                                <?php } ?>
                                            </div><?php
                                        break;
                                        case "0": ?>
                    ...
                    if($activate_response != true){ ?>
                                            <form action="index.php?step=0" method="POST">
                                                ...
                                                <div class="field">
                                                    <input type="hidden" value="<?php echo $license_code ?>"
                                                        name="license_code">
                                                    <input type="hidden" value="<?php echo $client_name ?>"
                                                        name="client_name">
                                                    <label class="label">License code</label>
                                                    <div class="control">
                                                        <input class="input" type="text"
                                                            placeholder="enter your purchase/license code"
                                                            name="license" value="Nulled By Codecanyom.com">
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    ...
                                                    <div class="control">
                                                        <input class="input" type="text"
                                                            placeholder="enter your name/envato username" name="client"
                                                            value="Nulled By Codecanyom.com">
                                                    </div>
                                                </div>
                                                <div class="mt-5">
                                                    <button type="submit"
                                                        class="btn btn-lg btn-primary btn-block btn-salon">Verify</button>
                                                </div>
                                            </form><?php
                                              }else{ ?>
                                            <form action="index.php?step=1" method="POST">
                                                ...
                                                <div class="mt-5">
                                                    <button type="submit"
                                                        class="btn btn-lg btn-primary btn-block btn-salon">Next</button>
                                                </div>
                                            </form><?php
                                            }
                                        }else{ ?>
                                        ...
                                        case "1": ?>
                                            ...
                                            <form action="index.php?step=1" method="POST">
                                                ...
                                                <div class="field">
                                                    ...
                                                    <div class="control">
                                                        <input class="input" type="text" id="user"
                                                            placeholder="enter your database username" name="user"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                ...
                                                <div class="mt-5">
                                                    <button type="submit"
                                                        class="btn btn-lg btn-primary btn-block btn-salon db-import">Import</button>
                                                </div>
                                            </form><?php
                                                exit;
                                                }
                                                $templine = '';
                                                $lines = file('../includes/thebarber.sql');
                                            ...
                                            <form action="index.php?step=2" method="POST">
                                                <div class='notification is-success'>Database was successfully imported.
                                                </div>
                                                ...
                                                <input type="hidden" name="db_name" id="db_name"
                                        ...
                                        ?>
                                            ...
                                            <form action="" id="adminDetailForm" method="post">
                                                <div class="field">
                                                    ...
                                                    <div class="control">
                                                        <input class="input" value="admin@gmail.com" type="text"
                                                            placeholder="Admin Name" name="name" readonly>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    <label class="label">Admin Password</label>
                                                    <div class="control">
                                                        <input class="input" value="admin123" type="text"
                                                ...
                                                <input type="hidden" name="db_name" id="db_name"
                                                    value="<?php echo $db_name; ?>">
                                                <div class="mt-5">
                                                    <button type="button" id="proceedLogin"
                                                        class="btn btn-lg btn-primary btn-block btn-salon">Proceed to
                                                        Login</button>
                                                </div>
                                            </form>
                                            <?php
                            ...
                            <div class="content has-text-centered mt-5">
                                <p>© <?php echo date('Y'); ?> Copyright TheBarber by <a href="https://saasmonks.in"
                                        target="/">SaaSMonks </a></p><br>
                            </div>
                        </div>
                    </div>
                </div>
...
jQuery(document).on("click", "#proceedLogin", function() {
